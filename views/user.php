...
$events=$conn->getAll("SELECT * FROM `admins`");
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3> <?php  echo utf8_encode("Usuários ")?><small>Cadastrados</small></h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Gerrenciar <small><?php  echo utf8_encode("Usuários ")?></small></h2>
